...
void CSINSGNSSDR::Init(const CSINS &sins0, int grade)
{
	...
	sins.lever(-lvGNSS);	sins.pos = sins.posL; // GNSS pos -> SINS0 pos
	sins.lever(lvOD);		posDR = sins.posL,  sins.posL = posDRL = sins0.pos;  //SINS0 pos -> DR0 pos
	avpi.Init(sins, kfts);
...
void CAligntf::SetHk(int nnq)
{
	...
	//Hk 如下
	/*
		Hk=[O33,I33, O33,O33,O33,Cnb*(webX),-an       //Zdvn
			I33,O33,-Cnb,O33,O33,O33,      ,-Cnb*wib] //Zdatt
	*/
