...
class CAlignsv;		class CAligntrkang;	class CAligntf;     class CCAM;			class CCALLH;		
class CVGHook;      class CRAvar;		class CVAR;			class CVARn;		class CIIR;			
class CIIRV3;       class CMaxMin;		class CMaxMinn;		class CRMemory;		class CSmooth;		
class CFileRdWt;    class CDR;			class CVAutoPOS;	class CPOS618;		class CAutoDrive;	
class CSINSGNSSOD;  class CSGOClbt;		class CWzhold;		class CUartPP;		class CInterp;		
class CFileLog;     class CVCFileFind;	class ConUart;		class CContLarge;	class CFileCfg;
